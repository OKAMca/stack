 ...
 */
type Documents = {
    "fragment BlockCustomComponents on block_custom_components {\n  name\n  props\n  settings {\n    ...BlockSettings\n  }\n}\n\nquery BlockCustomComponentsById($id: ID!) {\n  block_custom_components_by_id(id: $id) {\n    ...BlockCustomComponents\n  }\n}": typeof types.BlockCustomComponentsFragmentDoc,
    "fragment BlockFiles on block_files {\n  file {\n    ...DirectusFiles\n  }\n  settings {\n    ...BlockSettings\n  }\n}\n\nquery BlockFilesById($id: ID!) {\n  block_files_by_id(id: $id) {\n    ...BlockFiles\n  }\n}": typeof types.BlockFilesFragmentDoc,
 ...
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "fragment BlockCustomComponents on block_custom_components {\n  name\n  props\n  settings {\n    ...BlockSettings\n  }\n}\n\nquery BlockCustomComponentsById($id: ID!) {\n  block_custom_components_by_id(id: $id) {\n    ...BlockCustomComponents\n  }\n}"): (typeof documents)["fragment BlockCustomComponents on block_custom_components {\n  name\n  props\n  settings {\n    ...BlockSettings\n  }\n}\n\nquery BlockCustomComponentsById($id: ID!) {\n  block_custom_components_by_id(id: $id) {\n    ...BlockCustomComponents\n  }\n}"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "fragment BlockFiles on block_files {\n  file {\n    ...DirectusFiles\n  }\n  settings {\n    ...BlockSettings\n  }\n}\n\nquery BlockFilesById($id: ID!) {\n  block_files_by_id(id: $id) {\n    ...BlockFiles\n  }\n}"): (typeof documents)["fragment BlockFiles on block_files {\n  file {\n    ...DirectusFiles\n  }\n  settings {\n    ...BlockSettings\n  }\n}\n\nquery BlockFilesById($id: ID!) {\n  block_files_by_id(id: $id) {\n    ...BlockFiles\n  }\n}"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */

...
export { default as Collection } from './components/DirectusLink/components/Collection'
...
export type { TDirectusLink, TDirectusLinkConfig, TDirectusLinkProps } from './components/DirectusLink/interface'

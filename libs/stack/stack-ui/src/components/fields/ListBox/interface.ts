...
export interface TListBoxProps<I extends object = object, T extends TToken = TToken>
  extends Omit<TDefaultComponent<T>, 'children'>, AriaListBoxProps<I & TDefaultNodeComponent<I, T>> {
  /**
   * @default Anchor
   */
...
export interface TListBoxFormProps<I extends object = object, T extends TToken = TToken>
  extends Omit<TListBoxProps<I, T>, 'onBlur'>, TReactHookForm {}
export interface TControlledListBoxProps<I extends object = object, T extends TToken = TToken>
  extends Omit<TListBoxProps<I, T>, 'children'>, Partial<Pick<TListBoxProps<I, T>, 'children'>> {
  state: ListState<I>
}

export interface TControlledListBoxFormProps<I extends object = object, T extends TToken = TToken>
  extends TControlledListBoxProps<I, T>, Omit<TListBoxFormProps<I, T>, 'children' | 'onBlur'> {}

export interface TListBoxSectionProps<I extends object = object, T extends TToken = TToken>
  extends Omit<TDefaultComponent<T>, 'children'>, AriaListBoxSectionProps {
  section: TDefaultNode<I>
  state: ListState<I>
}

export interface TReactHookFormListBoxProps<I extends object = object, T extends TToken = TToken> extends Omit<
  TListBoxFormProps<I, T>,
  'selectionMode'
> {

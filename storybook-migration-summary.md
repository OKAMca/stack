...
- `npx storybook automigrate --config-dir libs/directus/directus-block/.storybook`

- `npx storybook automigrate --config-dir libs/stack/next-component/.storybook`

- `npx storybook automigrate --config-dir libs/stack/stack-ui/.storybook`

...
module.exports = {
    ...
    // Note: 'variants' option removed - Tailwind v3+ handles variants automatically
    // Note: 'safelist' removed in Tailwind v4 - use @source inline() in CSS instead
    // Focus-ring utilities are kept dynamically via matchUtilities below
    plugins: [
      // @tailwindcss/line-clamp removed - built into Tailwind 3.3+
      // tailwindcss-logical moved to @plugin directive in CSS files (Tailwind v4 requirement)
